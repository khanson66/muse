...
- `YOUTUBE_COOKIE` (Optional) can be obtained by logging into YouTube in your browser, then copying the cookie value from your browser's developer tools. This is required to play age-restricted videos.
